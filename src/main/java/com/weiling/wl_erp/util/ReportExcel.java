...
public class ReportExcel {
     ...
     * @throws IOException
     */
    public void excelReport(List list, String title, Class className, Integer exportType, HttpServletResponse response, HttpServletRequest request)throws IOException {
